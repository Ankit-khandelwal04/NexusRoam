  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        toast({ title: "Login Success", description: res });
        setSuccess(res);
      } else {
        const res = await registerUser({ name, email, phoneNumber, password, confirmPassword });
        toast({ title: "Registration Success", description: res });
        setSuccess(res);
      }
