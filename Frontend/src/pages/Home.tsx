        ...
        <div className="testimonials-container">
          <div className="testimonial">
            <p className="testimonial-text">
              "NexusRoam made planning my trip to Mumbai so much easier. The restaurant recommendations were fantastic!"
            </p>
            <p className="testimonial-author">- Palak Lokwani</p>
          </div>
          
          <div className="testimonial">
            <p className="testimonial-text">
              "The detailed transportation guides saved us a lot of time and confusion in Pune. Highly recommended!"
            </p>
            <p className="testimonial-author">- Ankit Khandelwal</p>
          </div>
          
          <div className="testimonial">
            <p className="testimonial-text">
              "I discovered hidden gems in Nashik that I wouldn't have found otherwise. This is my go-to travel companion now."
            </p>
            <p className="testimonial-author">- Janhavi Patil</p>
          </div>
        </div>
      </section>
